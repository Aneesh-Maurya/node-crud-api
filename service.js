...
module.exports={
    ...
    InsertData:async(req,res)=>{
        ...
        var query="insert into empData(firstname,lastname,email,mobile,salary)values('" + firstname + "','" + lastname + "','" + email+ "','" + mobile+ "','" + salary + "')"
        ...
        if (connection) {
          ...
          if (result) {
            ...
            console.log('sucess') //returns the result to the called function
          } else {
